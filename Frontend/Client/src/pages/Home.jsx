            ...
            <div className="text-center flex flex-col items-center space-y-6 max-w-4xl relative z-10">
              ...
              <div className="space-y-2">
                <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold leading-tight">
                  ...
                  <span className="inline-block animate-fade-in-up animation-delay-100">with</span>{' '}
                  <span className="inline-block animate-fade-in-up animation-delay-200">Your</span>
                </h2>
                <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold bg-gradient-to-r from-pink-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent animate-fade-in-up animation-delay-300">
              ...
              <div className="relative">
                <h1 className="text-5xl sm:text-6xl md:text-8xl font-black bg-gradient-to-r from-cyan-400 via-blue-500 to-pink-500 bg-clip-text text-transparent animate-fade-in-up animation-delay-400">
                  AniMate
                </h1>
